...
namespace Vendagas.API.Migrations
{
    ...
    [Migration("20240510163207_PedidoModelRealation")]
    partial class PedidoModelRealation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendagas.API.ORM.Entity.PedidoProdutoModel", b =>
                {
            ...
            modelBuilder.Entity("Vendagas.API.ORM.Entity.PedidoProdutoModel", b =>
                {
                    b.HasOne("Vendagas.API.ORM.Entity.PedidoModel", "Pedido")
                        .WithMany("Pedidos_Produtos")
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vendagas.API.ORM.Entity.ProdutoModel", "Produto")
                        .WithMany("Pedidos_Produtos")
